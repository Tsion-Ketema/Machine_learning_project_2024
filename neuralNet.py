...
#         # Convert regularization to an array of objects to preserve tuples
...
#                  regularization=regularization,  # Store as object array
...
#             # Properly load regularization as a tuple
